...
# data
input_size = (640, 640)
metafile = 'configs/_base_/datasets/miner-pose.py'
...
# train datasets
dataset_coco = dict(
    type='MinerPoseDataset',
    data_root=data_root,
    data_mode=data_mode,
    ann_file='miner-pose/annotations/person_keypoints_train2017.json',
    data_prefix=dict(img='miner-pose/train2017/'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file='miner-pose/annotations/person_keypoints_val2017.json',
        data_prefix=dict(img='miner-pose/val2017/'),
        test_mode=True,
...
# evaluators
val_evaluator = dict(
    type='MinerPoseMetric',
    ann_file=data_root + 'miner-pose/annotations/person_keypoints_val2017.json',
    score_mode='bbox',
    nms_mode='none',
)
